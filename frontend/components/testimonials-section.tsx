...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "We can verify anchor eligibility, enforce collateral requirements, and draw USDC prefunding without leaking our reserve sizes or corridor strength to the public.",
      name: "Treasury Director",
      company: "Global Remittance Anchor",
      image:
    ...
    {
      quote:
        "The CollateralLockRegistry prevents double-pledging of tokenized RWA collateral on-chain while keeping the underlying asset balances completely confidential.",
      name: "Risk Officer",
      company: "Prefunding Credit Facility",
      image:
    ...
    {
      quote:
        "Selective disclosure links let us provide regulators and auditors with complete verification of collateral and repayment trails without exposing them publicly.",
      name: "Compliance Auditor",
      company: "RWA Credit Protocol",
      image:
